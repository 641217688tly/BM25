...
每次运行此程序时，应首先将索引加载到内存中（在当前工作目录中名为“21207500-small.index”，将“21207500”替换为你的UCD学生号码），以便查询尽可能快。
...
该文件每行有一个查询，从其查询ID开始。
结果应存储在当前工作目录中的名为“21207500-small.results”的文件中（将“21207500”替换为你的UCD学生号码），
